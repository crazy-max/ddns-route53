...
6. Build your code with [GoReleaser](https://goreleaser.com/): `goreleaser release --skip-publish --skip-validate --rm-dist`
7. Push to your fork and [submit a pull request](https://github.com/crazy-max/ddns-route53/compare)
